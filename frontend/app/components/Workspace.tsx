...
export type Sample = { filename: string; content: string };
...
export default function Workspace({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (demo && sample && list.length === 0) {
        const f = new File([sample.content], sample.filename, { type: "text/plain" });
        await upload(f);
      }
    })();
  ...
  return (
    <div className="ws">
      <aside className="ws-side">
        ...
        {demo ? (
          <div className="ws-user ws-demo-side">
            <span className="ws-demo-tag">Demo mode</span>
            <a className="ws-demo-cta" href="/app">Create a free account &rarr;</a>
          </div>
        ) : (
      ...
      <main className="ws-main">
        {demo && (
          <div className="demo-banner">
            You&rsquo;re trying the demo. Documents here are temporary.{" "}
            <a href="/app">Create a free account</a> to save your own.
          </div>
        )}
        ...
        <div className="thread">
          {messages.length === 0 ? (
            <div className="welcome">
              ...
              {docs.length === 0 ? (
                <>
                  <h1>{uploading ? "Loading a sample…" : "Upload your first contract"}</h1>
